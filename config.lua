return {
	bot_api_key = '253659573:AAH3O0FmOPcKYzEwTumSTBByoUDyyWAhEMY',
	...
	channel = '@max_api_ch', --channel username with the '@'
	help_group = 'https://telegram.me/joinchat/DapRRz_ASjccT7D739gCOg', --group link, not username!
